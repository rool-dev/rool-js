...
description: Build extensions that extend Rool Spaces with custom AI-powered experiences. TypeScript SDK and Svelte bindings.
---
...
When you're ready to build your own extension, scaffold a new project with the extension CLI:
