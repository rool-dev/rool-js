...
<div class="flex flex-col h-full">
  <div class="flex items-center justify-between px-4 py-3 border-b border-slate-100 dark:border-slate-700">
    <span class="font-semibold text-slate-700 dark:text-slate-200 text-sm">Huddles</span>
    <button
      class="p-1 rounded-lg text-slate-400 hover:text-teal-600 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors md:hidden"
      onclick={onclose}
  ...
  <div class="px-3 py-2 border-b border-slate-100 dark:border-slate-700">
    <div class="flex items-center gap-1">
      <input
        class="flex-1 text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-1.5 outline-none focus:border-teal-400 min-w-0 text-slate-700 dark:text-slate-200 placeholder:text-slate-400"
      ...
      />
      <button
        class="p-1.5 rounded-lg text-slate-400 hover:text-teal-600 hover:bg-slate-100 dark:hover:bg-slate-700 disabled:opacity-30 transition-colors"
